...
<div class="margin clearfix">
 <div class="Guestbook_style">
	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700;">报名情况查询</h3>
 <div class="search_style">
     <!-- 查询窗格 -->
	 <form action="" method="post">
      <ul class="search_content clearfix">
	   <li><label class="l_f">活动名称</label><input name="act" type="text" class="text_add" placeholder="请输入活动名称" style=" width:200px"></li>
...
<div class="margin clearfix">
    <div class="Shops_Audit">
      <div class="prompt">当前共有<b><?php echo ($info1); ?></b>人报名</div>
