...
<div class="margin clearfix">
 <div class="Guestbook_style">
    <h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700;">用户统计</h3>
    <div class="search_style">
        <!-- 查询窗格 -->
		<form action="" method="post">
         <ul class="search_content clearfix">
          <li><label class="l_f">车型：</label><input name="type" type="text" class="text_add" placeholder="请输入车型名称" style=" width:210px"></li> 
          <li><label class="l_f"> &nbsp;俱乐部名称</label><input name="clubname" type="text" class="text_add" placeholder="请输入俱乐部名称" style=" width:200px"></li>
          <li style="width:90px;"><button type="submit" class="btn_search"><i class="fa fa-search"></i>统计</button></li>
          <!--<li style="width:90px;"><button type="button" class="btn_search_2">取消</button></li>-->
         </ul>
		 </form>
       </div>
	...
	<tbody>
		<tr>
			...
			<?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
				<td class="td-id"><?php echo ($k+1); ?></td>
                <td class="td-id"><?php echo ($v["nickname"]); ?></td>
                <td class="td-id"><?php echo ($v["gender"]); ?></td>
                <td class="td-id"><?php echo ($v["birth"]); ?></td>
                <td class="td-number"><?php echo ($v["tel"]); ?></td>
                <td class="td-id"><?php echo ($v["profession"]); ?></td>
                <td class="td-id"><?php echo ($v["type"]); ?></td>
                <td class="td-number"><?php echo ($v["carnumber"]); ?></td>
                <td class="td-loc"><?php echo ($v["clubname"]); ?></td>
    ...
    <div class="margin clearfix">
        <div class="Shops_Audit">
          <div class="prompt">当前共有<b><?php echo ($info1); ?></b>个用户</div>
