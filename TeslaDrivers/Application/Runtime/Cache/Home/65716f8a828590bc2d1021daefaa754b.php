...
<body>
	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700; margin-top: 20px;margin-left: 20px;">俱乐部添加</h3>
<div class="clearfix" id="add_picture">
	<form action="" method="post" class="form form-horizontal" id="form-article-add" novalidate>
		<div class=" clearfix cl">
         <label class="form-label col-2">俱乐部地点：</label>
	     <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="loc"></div>
        </div>
        <div class=" clearfix cl">
		...
		<div class="clearfix cl">
			<div class="Button_operation">
				...
				<a class="btn btn-default radius" href="<?php echo U('clubmanage_add');?>" type="button" value="">取消</a>
			</div>
		</div>
	</form>
    </div>
