...
<div class="margin clearfix">
 <div class="Guestbook_style">
	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700;">用户查询</h3>
 <div class="search_style">
     <!-- 查询窗格 -->
	 <form action="" method="post">
      <ul class="search_content clearfix">
       <li><label class="l_f">用户昵称</label><input name="nickname" type="text" class="text_add" placeholder="请输入用户昵称" style=" width:200px"></li>
       <li><label class="l_f">用户车型</label><input name="type" type="text" class="text_add" placeholder="请输入车型名称" style=" width:200px"></li>
