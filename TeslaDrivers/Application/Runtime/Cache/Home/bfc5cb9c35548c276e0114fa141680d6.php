...
<div class="margin clearfix">
 <div class="Guestbook_style">
     	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700;">俱乐部查询</h3>

 <div class="search_style">
     <!-- 查询窗格 -->
	 <form action="" method="post">
      <ul class="search_content clearfix">
       <li><label class="l_f">地点</label><input name="loc" type="text" class="text_add" placeholder="输入俱乐部地点" style=" width:200px"></li>
       <li><label class="l_f">名称</label><input name="name" type="text" class="text_add" placeholder="输入俱乐部名称" style=" width:200px"></li>
	...
	<tbody>
		<?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
          ...
          <td class="td-manage">
        <a  title="修改"  href="<?php echo U('clubmanage_update',array('cid'=>$v['cid']));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
		<a title="删除" href="<?php echo U('clubmanage_delete',array('cid'=>$v['cid']));?>" class="btn btn-xs btn-warning" onClick="delcfm()" ><i class="fa fa-trash  bigger-120"></i></a>
