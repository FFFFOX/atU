...
<body>
	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700; margin-top: 20px;margin-left: 20px;">活动列表</h3>
<div class="clearfix">
 ...
 <div class="Ads_list">
     <div class="article_list">
       ...
       <thead>
		 <tr>
				<th width="30px">ID</th>
                <th width="80px">活动图片</th>    
                <th width="20px">活动名称</th>
                <th width="60px">地点</th>
                <th width="20px">时间</th> 
                <th width="20px">更多</th>          
				<th width="30px">操作</th>
		...
		<?php if(is_array($info)): foreach($info as $k=>$v): ?><tr> 
          <td><?php echo ($k+1); ?></td>
          <td><img src="/TeslaDrivers/Public/<?php echo (substr($v["img"],9)); ?>" width="150"></td>
          <td><?php echo ($v["name"]); ?></td>
          <td><?php echo ($v["loc"]); ?></td>
          <td><?php echo ($v["date"]); ?></td>
          <td><a href="<?php echo U('actmanage_more',array('aid'=>$v['aid']));?>">详情</a></td>
          <td class="td-manage">   
           <a title="修改" href="<?php echo U('act_update',array('aid'=>$v['aid']));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
           <a title="删除" href="<?php echo U('act_delete',array('aid'=>$v['aid']));?>" class="btn btn-xs btn-danger" onClick="delcfm()"><i class="fa fa-trash bigger-120"></i></a>
          </td>
