...
<body>
	<h3 style="color: #3b98d6;font-family: '华文中宋'; font-weight: 700; margin-top: 20px;margin-left: 20px;">车型修改</h3>
<div class="clearfix" id="add_picture">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class=" clearfix cl">
         <label class="form-label col-2">车型名称：</label>
	     <div class="formControls col-10">
		 <input class="form-control" type="hidden" value="<?php echo ($info["tid"]); ?>" name="tid"/>
		...
		<div class="clearfix cl">
			<div class="Button_operation">
				...
				<a class="btn btn-default radius" href="<?php echo U('cartypemanage');?>" type="button" value="">取消</a>
			</div>
		</div>
	</form>
    </div>
